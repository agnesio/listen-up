...
var SpotifyWebApi = (function() {
   ...
   * @return {Object} Null if a callback is provided, a `Promise` object otherwise
   */
  Constr.prototype.getMySavedTracks = function(offset, options, callback) {
    var requestData = {
      url: _baseUri + '/me/tracks?offset='+offset+'&limit=50'
    };
    return _checkParamsAndPerformRequest(requestData, options, callback);
  };
  ...
  Constr.prototype.getMoreSavedTracks = function(url, options, callback) {
    console.log(url)
    var requestData = {
      url: url
    };
